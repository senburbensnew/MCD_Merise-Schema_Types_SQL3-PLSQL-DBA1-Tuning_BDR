...
spool &SCRIPTPATH\LOG\Ex101_Tune2_GESTION_CABINET_HOPITAL__3SPOOL.LOG
...
where table_name in ('EXAMEN','CONSULTATION','PRESCRIPTION','FACTURE','RENDEZ_VOUS','MEDECIN','PATIENT')
...
'SELECT * FROM PATIENT OP')
/
 

 INSERT INTO user_workload (username, module, action, priority, sql_text)
VALUES ('&MYPDBUSER', 'Example2', 'Action', 2,
 'SELECT * FROM CONSULTATION OC');
...
FROM (SELECT DISTINCT oe.Details_Examen AS details_examens FROM EXAMEN oe) E 
